...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
			$alam_al_anika_comment_count = get_comments_number();
			if ( '1' === $alam_al_anika_comment_count ) {
				printf(
					/* translators: 1: title. */
					esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'alam-al-anika' ),
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'alam-al-anika' ); ?></p>
			<?php
		endif;
